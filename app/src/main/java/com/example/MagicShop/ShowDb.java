        ...
        cameraBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        Uri photoURI = FileProvider.getUriForFile(ShowDb.this,
                                ShowDb.this.getApplicationContext().getPackageName() + ".provider",
                                photoFile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.e("CUPARH",""+file);
                try {
                    Bitmap bitmap = MediaStore.Images.Media.getBitmap(ShowDb.this.getContentResolver(), Uri.fromFile(file));
